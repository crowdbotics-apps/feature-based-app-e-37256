...
## Project Structure
    ...
    ├── feature_based_app_e_37256  # Django project configurations
...
1. Clone this repo and `cd feature_based_app_e_37256`
...
2. Clone this repo and `cd feature_based_app_e_37256`
